  ...
  <div className="flex flex-col items-center justify-center h-full text-center px-4">
    <div className="w-24 h-24 mb-4 opacity-30">
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-gray-400">
        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="round"/>
    ...
    <p className="text-sm text-gray-500 max-w-sm">
      Ask me anything about the content you've uploaded. I can answer questions, explain concepts, and help you understand your knowledge base.
    </p>
  </div>
);
